...
func NewRequestBuilder() *RequestBuilder {
	...
	rb.request.SetHeader("User-Agent", "postman-codegen/1.3.3 leddisplayapi/1.0.0 (go)")
	return rb
}
...
// Returns the builder for method chaining.
func (rb *RequestBuilder) WithConfig(config leddisplayapiconfig.Config) *RequestBuilder {
