...
import (
	"example.com/led-display-api/sdk/internal/clients/rest/handlers"
...
func NewRestClient[T any, E any](config leddisplayapiconfig.Config, hook hooks.Hook) *RestClient[T, E] {
