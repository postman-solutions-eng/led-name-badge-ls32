...
import (
	...
	"example.com/led-display-api/sdk/internal/contenttypes"
	"example.com/led-display-api/sdk/internal/serialization"
	"example.com/led-display-api/sdk/internal/utils"
...
type Request struct {
	...
	Options             any
	Body                any
	Config              leddisplayapiconfig.Config
...
func NewRequest(ctx context.Context, method string, path string, config leddisplayapiconfig.Config) Request {
	return Request{
		Context:             ctx,
		Method:              method,
		Path:                path,
